...
class TestBlockchain(ElectrumTestCase):
    ...
    def setUpClass(cls):
        ...
        # The headers above are Bitcoin regtest blocks. Doichain's regtest has
        # another genesis, which made every test here fail at the first header.
        cls._doichain_regtest_genesis = constants.net.GENESIS
        constants.net.GENESIS = hash_header(cls.HEADERS['A'])

    @classmethod
    def tearDownClass(cls):
        super().tearDownClass()
        constants.net.GENESIS = cls._doichain_regtest_genesis
...
class TestVerifyHeader(ElectrumTestCase):
    ...
    # Data for Bitcoin block header #100 (bits 0x1d00ffff, within Doichain's powLimit).
